 ...
 * 雪花算法ID生成器
 *
 * Created by qiuxiaotong on 2021/8/28
 */
public class SnowflakeIdWorker02 {
     ...
     * @param nodeId
     */
    public SnowflakeIdWorker02(int nodeId) {
    ...
    public static void main(String[] args) {
        SnowflakeIdWorker02 factory = new SnowflakeIdWorker02();
